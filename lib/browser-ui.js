    ...
    return {
        onDeviceRefreshEnd: function (nodeId) {
            ...
            panel.innerHTML = [
                ...
                '<p>Version 0.1.2 reports Desktop, Terminal and Files relay sessions. It does not add session blocking, prompt enforcement or mobile-specific UI.</p>',
                '</section></div>'
            ].join("");

            const page = document.getElementById("ct-page");
            page.style.boxSizing = "border-box";
            page.style.maxHeight = "calc(100vh - 150px)";
